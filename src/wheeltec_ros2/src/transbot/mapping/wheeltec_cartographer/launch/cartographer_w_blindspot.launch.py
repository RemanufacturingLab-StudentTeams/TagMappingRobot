...
def generate_launch_description():
    ...
    cartographer_config_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("wheeltec_cartographer"), "config"
        ),
    )
    ...
    filter_dir = get_package_share_directory("lidar_filter")
    launch_filter_dir = os.path.join(filter_dir, "launch")
    ...
    lidar_filter = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_filter_dir, "lidar_filter.launch.py")
        )
    )
