...
\section{ROS domain ID}\label{sec:ROS_ID}
...
If the robot and the laptop are correctly put on the same \texttt{ROS\_DOMAIN\_ID} the you should see the following in the terminal. Figure \ref{fig:talker} shows the output.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{./pictures/talker_listener.png}
	\caption{ROS network talker and listener above each other}
	\label{fig:talker}
\end{figure}
