...
If the robot and the laptop are correctly put on the same \texttt{ROS\_DOMAIN\_ID} the you should see the following in the terminal. \textbf{TODO: Make picture of the terminal while running this script.}
